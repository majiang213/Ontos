...
![图 1-1 LLM 直连企业系统的语义鸿沟](mermaid_1.png){width=16cm}
...
![图 4-1 元模型三类元素（语义 / 动力 / 治理）结构](mermaid_2.png){width=16cm}
...
![图 5-1 平台五层架构总览](mermaid_3.png){width=16cm}
...
![图 6-1 AI 建模助手的四路输入与人工确认流程](mermaid_4.png){width=16cm}
...
![图 7-1 Connect 四周试点实施路径](mermaid_5.png){width=16cm}
...
![图 8-1 Action 引擎完整执行链路](mermaid_6.png){width=16cm}
...
![图 9-1 人机协同决策闭环（建议—确认—执行—审计）](mermaid_7.png){width=16cm}

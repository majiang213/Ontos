...
3. **对人说清楚**：哪些对象唯一键你已经写上了、哪些还需要人看；有几对疑似重复，每对机器倾向是什么。然后请人到画布点「待确认」：先核对唯一键，再一对一对裁（同一 / 部分重叠 / 阶段 / 仅名称相似 / 跳过）。裁「同一」或「阶段」之后，跟被并掉的类还牵着的会改问留下的类，不是另起炉灶；你不要替人猜下一对该裁成哪一种。裁完点发布。
